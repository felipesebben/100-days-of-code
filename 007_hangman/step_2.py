...
# So if chosen_word was "apple", display should be ["_", "_", "_", "_", "_"]
...
# If the user guessed "p" and the chosen word was "apple", then display
# should be ["_", "p", "p", "_", "_"].
...
# 3. Print 'display' and you should see the guessed letter in the
